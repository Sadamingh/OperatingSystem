...
static void InitDefaultsscc_info_HelloReply_simple_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HelloReply_simple_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_HelloReply_simple_2eproto}, {}};

static void InitDefaultsscc_info_HelloRequest_simple_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HelloRequest_simple_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_HelloRequest_simple_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_simple_2eproto_sccs[2] = {
  &scc_info_HelloReply_simple_2eproto.base,
  &scc_info_HelloRequest_simple_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_simple_2eproto = {
  false, false, descriptor_table_protodef_simple_2eproto, "simple.proto", 136,
  &descriptor_table_simple_2eproto_once, descriptor_table_simple_2eproto_sccs, descriptor_table_simple_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_simple_2eproto::offsets,
  file_level_metadata_simple_2eproto, 2, file_level_enum_descriptors_simple_2eproto, file_level_service_descriptors_simple_2eproto,
};
...
void HelloRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_HelloRequest_simple_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void HelloReply::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_HelloReply_simple_2eproto.base);
  message_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
